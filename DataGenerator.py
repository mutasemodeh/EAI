...
def augment_render_capture(stl_variations_files_dir, jpeg_output_dir,num_variations):
    ...
    for subdir in tqdm(os.listdir(stl_variations_files_dir),desc="Augment_render_capture"):
            ...
            for stl_file in os.listdir(subdir_path):
                if stl_file.endswith('.stl'):
                    ...
                    for view_name, (eye, up) in views.items():
                        ...
                        render_and_capture(stl_file_path, jpeg_filename,num_variations=num_variations)
                        num_images_saved += 1
...
# Connect to PyBullet
    ...
    for var_index in range(num_variations + 1):  # +1 for the original file
        ...
        p.resetBasePositionAndOrientation(body_id, original_position, original_orientation)
        ...
        if var_index > 0:
            ...
            p.resetBasePositionAndOrientation(body_id, translation, p.getQuaternionFromEuler(rotation))
